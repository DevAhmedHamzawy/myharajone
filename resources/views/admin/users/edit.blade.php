                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.update', $user->name) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="telephone" class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{ $user->profile->telephone ?? '' }}" required autocomplete="telephone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="website"  class="form-control @error('website') is-invalid @enderror" name="website" value="{{ $user->profile->website ?? '' }}" required autocomplete="website">
