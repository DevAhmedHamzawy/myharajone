...
<form action="{{ route('posts.store') }}" method="post" class="p-5 bg-white">
    @csrf
    ...
    <div class="row form-group">       
        <div class="col-md-12">
          <input type="text" id="title" name="title" placeholder="إسم الإعلان" class="form-control">
        </div>
    </div>

    <div class="row form-group">       
        <div class="col-md-12">
          <textarea name="body" name="body" class="form-control" placeholder="وصف الإعلان" cols="30" rows="10"></textarea>
        </div>
    </div>
    ...
    <div class="row form-group">       
        <div class="col-md-6">
          <input type="text" name="telephone1" placeholder="رقم الهاتف/الجوال 1" class="form-control">
        </div>
        <div class="col-md-6">
    ...
    <div class="row form-group">       
        <div class="col-md-6">
          <input type="text" name="telephone2" placeholder="رقم الهاتف/الجوال 2" class="form-control">
        </div>
        <div class="col-md-6">
    ...
    <div class="row form-group">       
        <div class="col-md-6">
          <input type="email" id="email" name="email" placeholder="البريد الإلكترونى" class="form-control">
        </div>
        <div class="col-md-6">
